...
struct Pengguna pengguna[MAKS_PENGGUNA];
struct Produk produk[MAKS_PRODUK];
struct Transaksi transaksi[MAKS_TRANSAKSI];
struct Ulasan ulasan[MAKS_ULASAN];
int jumlah_pengguna = 0;
int jumlah_produk = 0;
int jumlah_transaksi = 0;
int jumlah_ulasan = 0;
struct Pengguna *pengguna_saat_ini = NULL;
